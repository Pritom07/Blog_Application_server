...
⚡ **A scalable and secure backend engine** powering a modern blogging platform.
...
- Role-based access control
  ...
  - **User** → Manage own posts & comments
...
- One **Comment** → Many **Replies** (self-referencing)
